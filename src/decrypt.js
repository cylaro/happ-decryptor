...
export function loadForgeKey(b64, header) {
...
export async function getCrypt5Keys() {
...
// Crypt1–4 pipeline
// ---------------------------------------------------------------------------
export async function decryptCrypt1to4(ordinal, payload) {
